...
最新版本内容，https://github.com/phodal/migration

模型与原则：

![To DDD](images/03Images/to-ddd.png)[查看大图](https://raw.githubusercontent.com/phodal/migration/master/images/to-ddd.png)

流程：

![重构流程](images/03Images/refactoring-process.png)[查看大图](https://raw.githubusercontent.com/phodal/migration/master/images/refactoring-process.png)

索引：

![Index](images/03Images/toc.jpg) [查看大图](https://raw.githubusercontent.com/phodal/migration/master/images/toc.jpg)
...
![四级重构](images/03Images/refactoring-levels-1.png)

这一点倒是与我们设计系统的时候，采用的《[架构金字塔](https://www.phodal.com/blog/architecture-pyramid/)》颇为一致的：

![架构金字塔](images/03Images/architecture-primard-1.jpg)
...
![技术债全景图](images/03Images/tech-debt-landscape.png)
...
![Classified Technical Debt Mapping](images/03Images/tech-debt-mapping.png)
...
![Coca Call Graph](images/03Images/coca-call.png)
...
![C4 模型](images/03Images/c4-model.jpg)
...
![高引用 + 高修改](images/03Images/refs-change.png)
...
![测试金字塔](images/03Images/test-primard.png)
...
![测试架构](images/03Images/test-arch.png)
...
![Quick ES](images/03Images/quick-ddd.png)
...
![整洁架构](images/03Images/full-clean-architecture.png)
...
![尖叫架构](images/03Images/screaming-architecture.png)
...
![](images/03Images/balanced-design.png)
...
![组件聚合](images/03Images/components-rules.png)
...
![Arlo Belshee 命名的七步骤](images/03Images/7_stages_of_naming.png)
...
![《实现模式》概览](images/03Images/implementation-patterns.png)
...
![Modeling](images/03Images/modeling.jpg)
...
![Path to Production](images/03Images/path-to-production.png)
