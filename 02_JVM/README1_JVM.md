...
![](/02_JVM/images/796D5F86-A1DB-4C49-841C-8E5A0F071BF3.png)

* 但是 无法解决 循环引用的问题。
![](/02_JVM/images/FF14127C-15B3-4646-BB8B-63E85C9DC5F5.png)

### 2 根可达算法
 而 hotspot里面用的是: 根可达查询/ Root Searching
![](/02_JVM/images/ABB321D8-1575-4D2B-B60A-FA8BF2A9B24F.png)
> 那么 哪些对象是根？
> 总而言之最开始生成的对象就是根对象。
...
### 1. Mark-Sweep/标记清楚
![](/02_JVM/images/5E03E0F5-DCA5-4133-964C-DAB93F2C5345.png)
...
![](/02_JVM/images/8C2E8802-F49C-4BED-AC49-9AAAC2E25265.png)
...
![](/02_JVM/images/86805EAC-F279-4A10-A5C9-226A1172539A.png)
...
![](/02_JVM/images/FF18BB2C-CAC7-4965-AC1A-E1757678A717.png)
...
![](/02_JVM/images/C083A505-E7FC-414C-9A98-0E32C4E0EA4C.png)
...
以下表示 一个对象的回收过程
![](/02_JVM/images/59AEE555-00AF-4FFF-A57B-92416D3D5CFB.png)
![](/02_JVM/images/3B3E9465-0593-4E24-AC8C-F95173149B63.png)
![](/02_JVM/images/B902F439-4483-47F0-A9E8-615081281939.png)

总结
![](/02_JVM/images/7A2BDF7C-426F-4745-8731-AC5939576294.png)
eden里面有TLAB，
...
* 使用copying算法
![](/02_JVM/images/8D542691-ADE2-4B28-96BA-E56A8319A826.png)
...
* 和 Serial的区别就是，GC是几个
![](/02_JVM/images/0528C9A3-A9FC-48C9-985D-49757513FF50.png)

### Parallel Old
* a compacting collector that uses multiple GC threads.
* 和 Serial Old的区别是， GC是几个
![](/02_JVM/images/579A95D5-EE67-4E1D-90F2-046A759561EC.png)
...
![](/02_JVM/images/50804399-2A9B-459C-8280-30296E439C13.png)
...
![](/02_JVM/images/8AD6258F-ED0D-47BD-A5C6-D77490484B11.png)
![](/02_JVM/images/318F010A-550F-4486-BEC9-EE228EE322D9.png)

CMS方案: Incremental Update
把A标记为灰色
![](/02_JVM/images/DB8B43EA-6867-4637-B4EF-EE30DC208029.png)

CMS方案: Incremental Update的非常隐蔽的问题
并发标记，产生漏标
![](/02_JVM/images/6C7F67F1-63D5-402B-8E15-E257A340B896.png)

所以CMS重新标记，必须重头到位扫描一遍

G1方案：SATB Snapshot At the Beggining
![](/02_JVM/images/4C2A7ED4-4E29-4D7A-972D-83F3A4EF0974.png)
